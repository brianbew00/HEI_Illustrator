...
# Input fields
home_value = st.number_input("Home Value ($)", value=1000000, step=20000, format="%d")
home_price_appreciation = st.number_input("Home Price Appreciation (%)", value=2.0, step=0.5, format="%.2f") / 100
premium_percentage = st.number_input("Premium Percentage (%)", value=20.0, step=0.5) / 100
hei_multiplier = st.number_input("HEI Multiplier", value=2.0, step=0.1)
investor_cap = st.number_input("Investor Cap (%)", value=20.0, step=0.5) / 100
